      ...
      <Container>
        ...
        <div className="mt-16 grid grid-cols-2 ">
          ...
          <div className="mb-8 lg:mb-0">
            ...
            <ul className="flex flex-col space-y-4 text-[14px] font-medium text-white">
              <li>Facebook<span className="text-red-300"> ! Coming Soon !</span></li>
              <li> <Link to="/">Twitter</Link></li>
              <li>Instagram <span className="text-red-300"> ! Coming Soon !</span></li>
              <li><Link to="https://www.linkedin.com/in/gautam-chaurasiya/">LinkedIn</Link></li>
              <li>YouTube <span className="text-red-300"> ! Coming Soon !</span></li>
            </ul>
          </div>
        </div>
      </Container>
      <div className="flex justify-center sm:justify-end px-8">
        <Link to={"https://github.com/1-SNK-KOS"}>
          <button
            type="button"
            className="rounded-md flex gap-2 mt-8  bg-white hover:bg-white/80  px-3 py-2 text-sm font-semibold text-black "
          >
            <img src={github} alt="github" />Created By Gautam Chaurasiya
          </button>
        </Link>
      </div>
